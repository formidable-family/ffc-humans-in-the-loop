...
data_file_name <- "imputed-lasso-constructed.rds"
prediction_name <- "lasso_lasso_imputation_constructed_covariates"
...
write_rds(x_cache, "data/cached/x_cache_constructed.rds")
write_rds(x_pred_cache, "data/cached/x_pred_cache_constructed.rds")
...
zip_prediction(prediction, prediction_name, run_file = "run_lasso_constructed.R")
