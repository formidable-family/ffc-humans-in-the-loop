...
#' Inputs: data/imputed/meanmode_imputed.rds
#' Outputs: output/predictions/{glmnet_mean_all, glmnet_mean_all_experts, glmnet_mean_all_mturkers}/prediction.csv
...
prediction_name <- "glmnet_mean_all"
...
write_rds(x_cache, "data/cached/x_cache_mean.rds")
write_rds(x_pred_cache, "data/cached/x_pred_cache_mean.rds")
...
zip_prediction(prediction_experts, prediction_name_experts, run_file = "run_lasso_all_mean.R")
zip_prediction(prediction_mturkers, prediction_name_mturkers, run_file = "run_lasso_all_mean.R")
