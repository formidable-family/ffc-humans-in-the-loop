...
zip_prediction(prediction_experts, prediction_name_experts, run_file = "run_lasso_all_lasso.R")
zip_prediction(prediction_mturkers, prediction_name_mturkers, run_file = "run_lasso_all_lasso.R")
